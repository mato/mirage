...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5c7cad0c787b962ab31da20facf72998) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("functoria.app", None);
                           FindlibPackage ("logs", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {
                      lib_modules = ["Mirage"; "Mirage_key"];
                      lib_pack = false;
                      lib_internal_modules = ["Mirage_version"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\248\132x\137.\232\206y\191\156\153\238.B\159\253";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
